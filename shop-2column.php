...
include 'header.php';
?>
<link rel="stylesheet" href="css/shop-2column.css">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-action"><a href="shop-3column.php" title="Three Column"><i class="fas fa-th"></i></a><a href="shop-2column.php" class="active" title="Two Column"><i class="fas fa-th-large"></i></a><a href="shop-1column.php" title="One Column"><i class="fas fa-th-list"></i></a></div>
                            </div>
                        </div>
                    </div>
