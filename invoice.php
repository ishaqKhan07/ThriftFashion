...
<link rel="stylesheet" href="css/invoice.css">
    <section class="inner-section single-banner" style="background: url(images/single-banner.jpg) no-repeat center;">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="product-video.php">product details</a></li>
    ...
    <section class="inner-section invoice-part">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center mt-5"><a class="btn btn-inline" href="#"><i class="icofont-download"></i><span>download invoice</span></a>
