...
include 'header.php';
?>
<link rel="stylesheet" href="css/shop-1column.css">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-action"><a href="shop-3column.php" title="Three Column"><i class="fas fa-th"></i></a><a href="shop-2column.php" title="Two Column"><i class="fas fa-th-large"></i></a><a href="shop-1column.php" class="active" title="One Column"><i class="fas fa-th-list"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="product-standard">
                                ...
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/01.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                                    <h5 class="standard-price"><del>$34</del><span>$28<small>/piece</small></span></h5>
                                    <div class="standard-rating"><i class="active icofont-star"></i><i class="active icofont-star"></i><i class="active icofont-star"></i><i class="active icofont-star"></i><i class="icofont-star"></i><a href="product-video.php">(3)</a></div>
                                    ...
                                    <div class="standard-action-group"><button class="product-add" title="Add to Cart"><i class="fas fa-shopping-basket"></i><span>add to cart</span></button>
                                        <div class="product-action"><button class="action-minus" title="Quantity Minus"><i class="icofont-minus"></i></button><input class="action-input" title="Quantity Number" type="text" name="quantity" value="1"><button class="action-plus" title="Quantity Plus"><i class="icofont-plus"></i></button></div><button class="standard-wish wish" title="Add to Wishlist"><i class="fas fa-heart"></i><span>add to wish</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="product-standard">
                                ...
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/02.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                        ...
                        <div class="col">
                            <div class="product-standard">
                                ...
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/03.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                        ...
                        <div class="col">
                            <div class="product-standard">
                                <div class="standard-label-group"><label class="standard-label feat">feature</label></div>
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/04.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                        ...
                        <div class="col">
                            <div class="product-standard">
                                <div class="standard-label-group"><label class="standard-label off">-15%</label></div>
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/05.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                        ...
                        <div class="col">
                            <div class="product-standard">
                                ...
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/06.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
                        ...
                        <div class="col">
                            <div class="product-standard">
                                <div class="standard-label-group"><label class="standard-label new">new</label></div>
                                <div class="standard-media"><a class="standard-image" href="product-video.php"><img src="images/product/07.jpg" alt="product"></a>
                                    <div class="standard-widget"><a title="Product Compare" href="compare.php" class="fas fa-random"></a><a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                                </div>
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="product-video.php">fresh green chilis</a></h4>
