...
<link rel="stylesheet" href="css/product-grid.css">
    <section class="single-banner inner-section" style="background: url(images/single-banner.jpg) no-repeat center;">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="shop-4column.php">shop-4column</a></li>
    ...
    <section class="inner-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-grid"><img src="images/product/01.jpg" alt="product"><img src="images/product/01.jpg" alt="product"><img src="images/product/01.jpg" alt="product"><img src="images/product/01.jpg" alt="product"></div>
                </div>
                <div class="col-lg-6">
                    <div class="details-content">
                        ...
                        <div class="details-action-group"><a class="details-wish wish" href="#" title="Add Your Wishlist"><i class="icofont-heart"></i><span>add to wish</span></a><a class="details-compare" href="compare.php" title="Compare This Item"><i class="fas fa-random"></i><span>Compare This</span></a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="product-details-frame">
                            <ul class="review-list">
                                ...
                                <li class="review-item">
                                    <div class="review-media"><a class="review-avatar" href="#"><img src="images/avatar/04.jpg" alt="review"></a>
    ...
    <section class="inner-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-btn-25"><a href="shop-4column.php" class="btn btn-outline"><i class="fas fa-eye"></i><span>view all related</span></a></div>
                </div>
            </div>
        </div>
    </section>
